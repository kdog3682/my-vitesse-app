...
async function transformDefineProp(code, id, edition = "kevinEdition", isProduction = false) {
  ...
  let definePropsCall;
  await _common.walkASTSetup.call(void 0, setupAst, (setup) => {
    setup.onEnter(
      (node, parent) => _common.isCallOf.call(void 0, node, "$") && _common.isCallOf.call(void 0, node.arguments[0], _common.DEFINE_PROP) || !_common.isCallOf.call(void 0, parent, "$") && _common.isCallOf.call(void 0, node, _common.DEFINE_PROP),
      (node, parent) => {
        const propName = walkCall(
          _common.isCallOf.call(void 0, node, "$") && _common.isCallOf.call(void 0, node.arguments[0], _common.DEFINE_PROP) ? node.arguments[0] : node,
          parent
        );
        s.overwriteNode(
          node,
          `${_common.importHelperFn.call(void 0, s, offset, "toRef")}(__props, ${JSON.stringify(
            propName
          )})`,
          { offset }
        );
    ...
    setup.onEnter(
      (node) => _common.isCallOf.call(void 0, node, _common.DEFINE_PROPS),
      (node) => {
...
exports.stringifyArray = stringifyArray; exports.kevinEdition = kevinEdition; exports.johnsonEdition = johnsonEdition; exports.code_default = code_default; exports.helperId = helperId; exports.PROPS_VARIABLE_NAME = PROPS_VARIABLE_NAME; exports.transformDefineProp = transformDefineProp;
