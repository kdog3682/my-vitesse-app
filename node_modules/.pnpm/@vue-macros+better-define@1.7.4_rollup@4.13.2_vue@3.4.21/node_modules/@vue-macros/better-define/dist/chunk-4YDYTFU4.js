...
var _chunkQOUBAYKXjs = require('./chunk-QOUBAYKX.js');
...
function resolveOptions(options, framework) {
  ...
  return {
    include,
    isProduction: _process2.default.env.NODE_ENV === "production",
    ...options,
    version
  };
}
  ...
  (userOptions = {}, { framework }) => {
    ...
    return {
      ...
      async transform(code, id) {
        try {
          return await _chunkQOUBAYKXjs.transformBetterDefine.call(void 0, code, id, options.isProduction);
        } catch (error) {
