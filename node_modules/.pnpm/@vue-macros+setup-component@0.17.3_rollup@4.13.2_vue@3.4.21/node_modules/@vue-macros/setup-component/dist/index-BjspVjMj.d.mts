import { AttachedScope } from '@vue-macros/common';
...
declare function transformSetupComponent(code: string, _id: string, ctx: SetupComponentContext): {
    code: string;
    map: any;
} | undefined;
...
declare function transformPost(code: string, _id: string): {
    code: string;
    map: any;
} | undefined;
