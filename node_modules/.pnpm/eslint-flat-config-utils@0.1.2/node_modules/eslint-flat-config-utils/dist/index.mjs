...
function pipe(...configs) {
  return new FlatConfigPipeline().append(...configs);
}
class FlatConfigPipeline extends Promise {
  constructor() {
    super(() => {
    });
...
export { FlatConfigPipeline, concat, defineFlatConfig, mergeConfigs, pipe, renamePluginsInConfigs, renamePluginsInRules };
