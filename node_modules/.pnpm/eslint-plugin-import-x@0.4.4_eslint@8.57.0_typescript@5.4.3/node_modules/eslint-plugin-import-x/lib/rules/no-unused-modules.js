...
module.exports = (0, utils_2.createRule)({
    ...
    create(context) {
        ...
        const file = (0, eslint_compat_utils_1.getPhysicalFilename)(context);
        ...
        const updateExportUsage = (node) => {
            ...
            const exports = (_a = exportList.get(file)) !== null && _a !== void 0 ? _a : new Map();
        ...
        const updateImportUsage = (node) => {
            ...
            const oldImportPaths = (_a = importList.get(file)) !== null && _a !== void 0 ? _a : new Map();
            ...
            (0, utils_2.visit)(node, visitorKeyMap.get(file), {
