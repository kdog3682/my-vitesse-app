    ...
    create(context) {
        ...
        return (0, utils_1.moduleVisitor)(source => {
            ...
            context.report({
                ...
                messageId: 'absolute',
                fix(fixer) {
                    const resolvedContext = (0, eslint_compat_utils_1.getPhysicalFilename)(context);
                    let relativePath = node_path_1.default.posix.relative(node_path_1.default.dirname(resolvedContext), source.value);
