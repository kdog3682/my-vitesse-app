...
function fixNewLineAfterImport(context, previousImport) {
    ...
    const tokensToEndOfLine = takeTokensAfterWhile((0, eslint_compat_utils_1.getSourceCode)(context), prevRoot, commentOnSameLineAs(prevRoot));
        ...
        return {
            ...
            TSImportEqualsDeclaration(node) {
                ...
                if (node.moduleReference.type === 'TSExternalModuleReference' &&
                    ...
                    value = '';
                    displayName = (0, eslint_compat_utils_1.getSourceCode)(context).getText(node.moduleReference);
                    type = 'import:object';
                }
                registerNode(context, {
                    node,
