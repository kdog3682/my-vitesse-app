...
module.exports = (0, utils_1.createRule)({
    ...
    create(context) {
        ...
        const ignoreModule = (name) => options.ignoreExternal &&
            (0, utils_1.isExternalModule)(name, (0, utils_1.resolve)(name, context), context);
